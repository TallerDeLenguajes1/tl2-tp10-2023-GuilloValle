...
var CadenaDeConexion = builder.Configuration.GetConnectionString("SqliteConexion")!.ToString(); // para dar el valor de la conexion de la BD en los contructores de los repositorios y no repetir codigo
