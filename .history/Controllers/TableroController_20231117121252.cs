...
public class TableroController : Controller
{
    ...
    [HttpPost]
    public IActionResult ModificarTablero(int id,Tablero tableroNuevo)
    {   
        tableroRepository.ModificarTablero(id,tableroNuevo);
        return RedirectToAction("Index");
    }
    
    public IActionResult EliminarUsuario(int idTablero)
    {
