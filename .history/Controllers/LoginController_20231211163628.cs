    ...
    public class LoginController : Controller
    {
        ...
        {   
          ...
          try
          {
              ...
              if(user == null){
                _logger.LogWarning("Intento de acceso invalido - Usuario:" + usuarioLogueado.Nombre + " Clava ingresada:"+ usuarioLogueado.Contrasenia);
                return RedirectToAction("Index");
              } 
              LoguearUsuario(user);
              _logger.LogInformation("el usuario" + usuarioLogueado.Nombre  + "ingreso correctamente");
